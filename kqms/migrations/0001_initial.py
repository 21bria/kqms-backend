# Generated by Django 4.2 on 2026-02-09 00:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='domeAdjustmentView',
            fields=[
                ('id', models.BigIntegerField(default=None, primary_key=True, serialize=False)),
                ('dome', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('current_total', models.FloatField(blank=True, default=0, null=True)),
                ('target_total', models.FloatField(blank=True, default=0, null=True)),
                ('scale_factor', models.FloatField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.CharField(default='Import Task', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sm', models.FloatField(blank=True, null=True)),
                ('al203', models.FloatField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='weather',
            index=models.Index(fields=['date', 'shift', 'category', 'start_time', 'end_time'], name='idx_weather_duplicate_check'),
        ),
        migrations.AddIndex(
            model_name='waybills',
            index=models.Index(fields=['sample_id'], name='waybills_sample__63bfe1_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='vendors',
            index=models.Index(fields=['vendor_name'], name='vendors_vendor__4ce451_idx'),
        ),
        migrations.AddIndex(
            model_name='vendors',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['name'], name='mine_units__name_15b89a_idx'),
        ),
        migrations.AddIndex(
            model_name='unitstatus',
            index=models.Index(fields=['category'], name='mine_units__categor_98388d_idx'),
        ),
        migrations.AddIndex(
            model_name='unitscategories',
            index=models.Index(fields=['category'], name='units_categ_categor_310a2f_idx'),
        ),
        migrations.AddField(
            model_name='unitactivity',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='activities', to='kqms.unitstatus'),
        ),
        migrations.AddField(
            model_name='stockpilebalance',
            name='material',
        ...
        migrations.AddField(
            model_name='stockpilebalance',
            name='stockpile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kqms.sourceminesdumping'),
        ),
        migrations.AddIndex(
            model_name='stockfactories',
            index=models.Index(fields=['factory_stock'], name='stock_facto_factory_5c8468_idx'),
        ),
        migrations.AddField(
            model_name='sourceminesloading',
            name='id_sources',
            field=models.ForeignKey(blank=True, db_column='id_sources', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mine_sources_point_loading_sources_FK', to='kqms.sourcemines'),
        ),
        migrations.AddIndex(
            model_name='sourceminesdumping',
            index=models.Index(fields=['dumping_point'], name='mine_source_dumping_4a4dce_idx'),
        ),
        migrations.AddIndex(
            model_name='sourceminesdome',
            index=models.Index(fields=['pile_id'], name='mine_source_pile_id_7dc127_idx'),
        ),
        migrations.AddField(
            model_name='sourcemines',
            name='id_iup',
            field=models.ForeignKey(blank=True, db_column='id_iup', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mine_iup_mine_sources_FK', to='kqms.mineiup'),
        ),
        migrations.AddIndex(
            model_name='sellingsurveyor',
            index=models.Index(fields=['code_surveyor'], name='ore_selling_code_su_5eda91_idx'),
        ),
        migrations.AddIndex(
            model_name='sellingsurveyor',
            index=models.Index(fields=['name_surveyor'], name='ore_selling_name_su_298d81_idx'),
        ),
        migrations.AddField(
            model_name='sampletypedetails',
            name='id_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details_type_sample', to='kqms.sampletype'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='sampleproductions',
            index=models.Index(fields=['sampling_deskripsi'], name='samples_pro_samplin_7fef0f_idx'),
        ),
        migrations.AddIndex(
            model_name='sampleproductions',
            index=models.Index(fields=['sample_dup'], name='samples_pro_sample__3eb629_idx'),
        ),
        migrations.AddIndex(
            model_name='sampleproductions',
        ...
        migrations.AddIndex(
            model_name='samplecrmcertified',
            index=models.Index(fields=['oreas_name'], name='sample_crm__oreas_n_33f340_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['unit_code'], name='mine_units_unit_co_94c414_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddField(
            ...
            name='activity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kqms.unitactivity'),
        ),
        migrations.AddField(
            model_name='hmunitdetail',
            name='hm_unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details', to='kqms.hmunit'),
        ),
        migrations.AddField(
            model_name='hmunitdetail',
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kqms.unitlocation'),
        ),
        migrations.AddField(
            model_name='hmunitdetail',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kqms.unitstatus'),
        ),
        migrations.AddField(
            model_name='hmunit',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='hm_units', to='kqms.mineunits'),
        ),
        migrations.AddIndex(
            model_name='fuelconsumption',
            index=models.Index(fields=['date'], name='mine_units__date_fe63df_idx'),
        ),
        migrations.AddIndex(
            model_name='fuelconsumption',
            index=models.Index(fields=['unit'], name='mine_units__unit_2f0360_idx'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['barge_code'], name='master_barg_barge_c_b5deb2_idx'),
        ),
        migrations.AddIndex(
            model_name='bargeunits',
            index=models.Index(fields=['barge_name'], name='master_barg_barge_n_f04703_idx'),
        ),
        migrations.AddIndex(
            model_name='bargeport',
            index=models.Index(fields=['port_name'], name='master_barg_port_na_e323d2_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='stockpilebalance',
        ...
        migrations.AddIndex(
            model_name='sourceminesloading',
            index=models.Index(fields=['loading_point'], name='mine_source_loading_70333c_idx'),
        ),
        migrations.AddIndex(
            model_name='oreclass',
            index=models.Index(fields=['ore_class'], name='ore_classes_ore_cla_c3d981_idx'),
        ),
        migrations.AddIndex(
            model_name='oreclass',
            index=models.Index(fields=['material'], name='ore_classes_materia_25afa3_idx'),
        ),
        migrations.AddIndex(
            model_name='hmunitdetail',
            index=models.Index(fields=['hm_unit'], name='mine_hm_uni_hm_unit_a650f9_idx'),
        ),
        migrations.AddIndex(
            model_name='hmunitdetail',
            index=models.Index(fields=['start_time', 'end_time'], name='mine_hm_uni_start_t_106fa1_idx'),
        ),
        migrations.AddIndex(
            model_name='hmunitdetail',
            index=models.Index(fields=['category'], name='mine_hm_uni_categor_8391e1_idx'),
        ),
        migrations.AddIndex(
            model_name='hmunit',
            index=models.Index(fields=['unit'], name='mine_hm_uni_unit_id_55493b_idx'),
        ),
        migrations.AddIndex(
            model_name='hmunit',
            index=models.Index(fields=['date'], name='mine_hm_uni_date_ad2f18_idx'),
        ),
        migrations.AddIndex(
            model_name='hmunit',
            index=models.Index(fields=['shift'], name='mine_hm_uni_shift_b9856a_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='hmunit',
