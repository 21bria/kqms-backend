...
class SellingDetailsBargingView(models.Model):
    ...
    # ritase              = models.FloatField(default=None, null=True, blank=True)
    ...
    nota                = models.CharField(max_length=255, default=None, null=True, blank=True)
    sale_adjust         = models.CharField(max_length=255, default=None, null=True, blank=True)
    sale_dome           = models.CharField(max_length=255, default=None, null=True, blank=True)
