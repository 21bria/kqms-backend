...
@shared_task(name='kqms.task.import_plan_productions.import_plan_productions')
def import_plan_productions(file_path, original_file_name):
            ...
            for index, row in df.iterrows():
                ...
                try:
                    data = planProductions(
                        ...
                        biomass=Biomass,
                        ref_plan=ref_plan,
                        task_id=import_plan_productions.request.id,
                    )
