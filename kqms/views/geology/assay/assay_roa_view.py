...
def assay_roa_page(request):
    ...
    return render(request, 'admin-mgoqa/assay/list-roa.html',context)
...
def export_data_roa(request):
    ...
    # Header dan kolom yang diambil dari model
    headers = [
        'No', 'Date', 'Job Number', 'Sample Id', 'Ni', 'Co', 'Al2O3',
        'CaO', 'Cr2O3', 'Fe2O3', 'Fe', 'MgO', 'SiO2', 'MC'
    ]
    columns = [
        'release_roa', 'job_number', 'sample_id', 'ni', 'co', 'al2o3',
        'cao', 'cr2o3', 'fe2o3', 'fe', 'mgo', 'sio2', 'mc'
    ]
    ...
    # Query data
    queryset = AssayRoa.objects.values_list(*columns)
